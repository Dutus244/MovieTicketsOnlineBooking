...
//    private fun insertDataReview(review: ReviewModel) {
//        val reviewModel = ReviewModel(
//            review.getName(),
//            review.getReview(),
//            review.getTimeStamp(),
//            review.getTotalStarGiven()
//        )
//        val collectionReference = firebaseFirestore.collection("product")
//        val documentReference = collectionReference.document(
//            filmReviewModel!!.idProduct!!
//        )
//        documentReference.collection("review")
//            .add(reviewModel)
//            .addOnSuccessListener { documentReference1: DocumentReference? ->
//                progressDialog!!.dismiss()
//                //after success, then update the rating in product
//                updateRating(review, filmReviewModel!!)
//            }
...
//    private fun updateRating(reviewModel: ReviewModel, productModel: ProductModel) {
//        val rate = ProductModel()
//        rate.idProduct = productModel.idProduct
//        rate.productName = productModel.productName
//
//        //update stars
//        val totalStars: Double
//        var totalVoters = 0
//        if (reviewModel.totalStarGiven == 1.0) {
//            totalStars = 1.0 + productModel.star1.toDouble()
//            rate.star1 = totalStars.toInt()
//            rate.star2 = productModel.star2
//            rate.star3 = productModel.star3
//            rate.star4 = productModel.star4
//            rate.star5 = productModel.star5
//            totalVoters =
//                (totalStars + productModel.star2 + productModel.star3 + productModel.star4 + productModel.star5).toInt()
//            if (productModel.totalVoters == 0) {
//                rate.totalVoters = 1
//            } else {
//                rate.totalVoters = totalVoters
//            }
//        } else if (reviewModel.totalStarGiven == 2.0) {
//            totalStars = 1.0 + productModel.star2.toDouble()
//            rate.star1 = productModel.star1
//            rate.star2 = totalStars.toInt()
//            rate.star3 = productModel.star3
//            rate.star4 = productModel.star4
//            rate.star5 = productModel.star5
//            totalVoters =
//                (totalStars + productModel.star1 + productModel.star3 + productModel.star4 + productModel.star5).toInt()
//            if (productModel.totalVoters == 0) {
//                rate.totalVoters = 1
//            } else {
//                rate.totalVoters = totalVoters
//            }
//        } else if (reviewModel.totalStarGiven == 3.0) {
//            totalStars = 1.0 + productModel.star3.toDouble()
//            rate.star1 = productModel.star1
//            rate.star2 = productModel.star2
//            rate.star3 = totalStars.toInt()
//            rate.star4 = productModel.star4
//            rate.star5 = productModel.star5
//            totalVoters =
//                (totalStars + productModel.star1 + productModel.star2 + productModel.star4 + productModel.star5).toInt()
//            if (productModel.totalVoters == 0) {
//                rate.totalVoters = 1
//            } else {
//                rate.totalVoters = totalVoters
//            }
//        } else if (reviewModel.totalStarGiven == 4.0) {
//            totalStars = 1.0 + productModel.star4.toDouble()
//            rate.star1 = productModel.star1
//            rate.star2 = productModel.star2
//            rate.star3 = productModel.star3
//            rate.star4 = totalStars.toInt()
//            rate.star5 = productModel.star5
//            totalVoters =
//                (totalStars + productModel.star1 + productModel.star2 + productModel.star3 + productModel.star5).toInt()
//            if (productModel.totalVoters == 0) {
//                rate.totalVoters = 1
//            } else {
//                rate.totalVoters = totalVoters
//            }
//        } else if (reviewModel.totalStarGiven == 5.0) {
//            totalStars = 1.0 + productModel.star5.toDouble()
//            rate.star1 = productModel.star1
//            rate.star2 = productModel.star2
//            rate.star3 = productModel.star3
//            rate.star4 = productModel.star4
//            rate.star5 = totalStars.toInt()
//            totalVoters =
//                (totalStars + productModel.star1 + productModel.star2 + productModel.star3 + productModel.star4).toInt()
//            if (productModel.totalVoters == 0) {
//                rate.totalVoters = 1
//            } else {
//                rate.totalVoters = totalVoters
...
//
//        //update rate
//        val totalStar1 = rate.star1 * 1
//        val totalStar2 = rate.star2 * 2
//        val totalStar3 = rate.star3 * 3
//        val totalStar4 = rate.star4 * 4
//        val totalStar5 = rate.star5 * 5
//        val sumOfStars = (totalStar1 + totalStar2 + totalStar3 + totalStar4 + totalStar5).toDouble()
//        val totalRating = sumOfStars / totalVoters.toDouble()
//        val format = DecimalFormat(".#")
//        rate.totalRating = format.format(totalRating).toDouble()
//        val collectionReference = firebaseFirestore.collection("product")
//        collectionReference.document(productModel.idProduct!!)
//            .set(rate)
...
//                    Toast.LENGTH_SHORT
//                ).show()
//                filmReviewModel = rate
//                setRatingByColor(rate)
////                getAllReview(productModel.idProduct!!)
//            }
//            .addOnFailureListener { e ->
//                progressDialog!!.dismiss()
//                Toast.makeText(
//                    this,
//                    "Failed Update Rating : " + e.message,
//                    Toast.LENGTH_SHORT
//                ).show()
//            }
//    }
